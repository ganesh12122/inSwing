from sqlalchemy import Column, String, DateTime, Boolean, Enum, Text, Integer, Float
...
class User(Base):
    ...
    role = Column(Enum('player', 'admin', name='user_role'), default='player', nullable=False)
    ...
    hosted_matches = relationship("Match", back_populates="host", foreign_keys="Match.host_user_id")
