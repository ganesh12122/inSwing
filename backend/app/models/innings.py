from sqlalchemy import Column, String, DateTime, Boolean, Integer, Float, ForeignKey, Enum, JSON
...
class Innings(Base):
    ...
    overs_bowled = Column(Float, default=0.0, nullable=False)  # 4.3 means 4 overs and 3 balls
